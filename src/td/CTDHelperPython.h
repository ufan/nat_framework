...
public:
	...
	void doDelOrder(int track_id) {exch_.delOrder(getOrderTrack(track_id).order_ref);}
	...
	virtual void on_switch_day(string day) {closeOrderTrack(); exch_.on_switch_day(day);}
