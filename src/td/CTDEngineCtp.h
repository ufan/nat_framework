...
class CTDEngineCtp : public ITDEngine, public CThostFtdcTraderSpi {
 public:
  ...
  // 2. Setup an TradeApi instance for each account configured, but all TradeApi
  // share this Spi instance
 ...
 protected:
  ...
  vector<AccountUnitCTP> account_units_;  // collection of accounts managed,
