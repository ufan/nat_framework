 ...
 *
 * Comment by Yong:
 * CService is implemented to process the read/write of a server socket.
 * Each daughter of CService could be implemented to provide a specific service
 * for a server, like CSignalServer.
 * It also has the connect method for initializing a connection as a client like
 * CSignalRequester.
 */
