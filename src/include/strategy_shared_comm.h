...
#define SHARED_STG_INIT_TABLE(t)	(t).init(SHARED_STG_HASH_BASE, SHARED_STG_HASH_DEEP, SHARED_STG_HASH_SHMKEY)

#define SHARED_STG_STR_TO_KEY(s)	SHARED_STG_HASH(s.data(), (s.size() < SHARED_STG_NAME_MAX_SIZE ? s.size() : SHARED_STG_NAME_MAX_SIZE - 1))
