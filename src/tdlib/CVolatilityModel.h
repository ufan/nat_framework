...
private:
    ...
    void Evaluate_volatility_time(double timeleft, double total_time, const CSigmaSignal& sigmasignal);
    void Evaluate_volatility_onetick(const CSigmaSignal& sigmasignal);
    
public:
    double RetInstantVolatility() const;
    void   OnTick(double timeleft, double total_time, const CSigmaSignal& sigmasignal);
